...
class AzureUsage:
    ...
    def __init__(self):
        ...
        self.costmanagementUrl = "https://management.azure.com/" + scope + \
            "/providers/Microsoft.CostManagement/query?api-version=2019-11-01&$top=4000"
        authority_uri = automationassets.get_automation_variable("activeDirectoryEndpointUrl") + \
            "/" + tenant_id
        context = adal.AuthenticationContext(authority_uri)
        token = context.acquire_token_with_client_credentials(
            automationassets.get_automation_variable("resourceManagerEndpointUrl"),
            automationassets.get_automation_variable("clientId"),
            automationassets.get_automation_variable("clientSecret"))
    ...
    def send_mail(self, body1, body2):
        ...
        receivers = ['xxx@mycompany.com','xxx@mycompany.com','xxx@mycompany.com','xxx@mycompany.com','xxx@mycompany.com']
